...
router.post("/", async function (req, res, next) {
  try {
    ...
    // 2. THÊM ĐOẠN NÀY: Tự động tạo Inventory sau khi tạo Product thành công
    await inventoryController.CreateInventoryForProduct(newObj._id);
